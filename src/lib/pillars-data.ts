// Drawbridge Lending — SEO pillar pages for New Orleans, LA.
...
export const MONEY_PILLARS: Pillar[] = [
  {
    ...
    description:
      "Asset-based lines built around the receivables of New Orleans staffing firms, logistics operators, manufacturing suppliers and B2B vendors that wait 30-90 days to get paid. Borrow against the AR ledger without selling the invoices.",
  ...
  },
  {
    ...
    description:
      "Same-day liquidity for Central Louisiana trucking, staffing and government-contracting firms. Recourse and non-recourse programs with transparent advance rates and no long-term lock-ins.",
  ...
  },
  {
    ...
    description:
      "Compare term loans, SBA, lines of credit, equipment financing and revenue-based capital through a single soft-pull application. Whitfield matches New Orleans operators with the lender most likely to fund their deal.",
  ...
  },
  {
    ...
    kind: "money",
    tagline: "Local New Orleans loan advisors, statewide lender bench",
    description:
      "Skip the call-the-bank routine. Talk to a New Orleans-based loan advisor who knows the Orleans Parish lender bench, then get matched with 75+ regional, SBA preferred and national programs in one application.",
    bullets: ["New Orleans-based advisors", "75+ regional & national lenders", "One soft application"],
  ...
  },
  {
    ...
    title: "SBA Loans",
    kind: "money",
    tagline: "Government-backed funding for New Orleans businesses",
    description:
  ...
  },
  {
    ...
    description:
      "The most flexible SBA program for working capital, equipment, acquisition or partner buy-out. Popular among Dublin medical practices and French Quarter hospitality operators.",
  ...
  },
  {
    ...
    kind: "money",
    tagline: "Buy an existing New Orleans business",
    description:
  ...
  },
  {
    ...
    kind: "money",
    tagline: "Funding for new Central Louisiana ventures",
    description:
  ...
  },
  {
    ...
    description:
      "Cash-flow underwritten loans for established New Orleans businesses with consistent monthly revenue — no UCC blanket lien required.",
...
export const VERTICAL_PILLARS: Pillar[] = [
  {
    ...
    description:
      "Capital to add tractors, cover insurance down payments and bridge slow-pay receivables, built for I-70 and I-10 freight economics serving New Orleans distribution hubs.",
  ...
  },
  {
    ...
    description:
      "Open a second location, refresh the dining room or weather a slow season with capital sized to New Orleans hospitality cash flow — French Quarter, German Village and beyond.",
  ...
  },
  {
    ...
    description:
      "Finance chairs, CBCT imaging, build-outs or a full practice purchase with structures designed for DSOs and solo New Orleans dentists.",
  ...
  },
  {
    ...
    description:
      "Equipment, working capital and AR factoring for manufacturers and industrial operators in the New Orleans metro — sized to production cycles and OEM payment terms.",
  ...
  },
  {
    ...
    description:
      "Capital for flagged and independent properties along the I-610 corridor and Downtown Columbus: acquisitions, brand-mandated PIPs, FF&E and refinances.",
  ...
  },
  {
    ...
    description:
      "Stock up for the season, open a second location or refresh your New Orleans storefront with capital sized to retail cash flow cycles.",
  ...
  },
  {
    ...
    description:
      "Finance individual machines or full production cells with structures aligned to ROI timelines — including soft costs and step-payment options for New Orleans and Central Louisiana manufacturers.",
