...
export const INDUSTRIES: Industry[] = [
  ...
  },
  {
    ...
    intro:
      "Working capital, equipment financing and hotel CapEx for the operators driving the French Quarter, German Village, Easton and the I-610 hotel corridor.",
    services: [
      make(
        "restaurant-loans",
        "Restaurant Loans",
        ...
        "Open a second location, refresh the dining room or weather a slow season with capital structured for New Orleans hospitality cash flow.",
      ...
      make(
        ...
        "Capital for flagged and independent properties along the I-610 corridor and Downtown Columbus: acquisitions, brand-mandated PIPs and refinances.",
  ...
  },
  {
    ...
    intro:
      "From owner-operators on I-70 to mid-size fleets running the Gulf South distribution lanes: trucks, trailers, repair bays and the working capital that holds it all together.",
    services: [
      make(
        ...
        "Capital to add tractors, cover insurance down payments, fuel up and bridge slow-pay receivables, built for Central Louisiana trucking economics.",
  ...
  },
  {
    ...
    intro:
      "Inventory financing, build-outs and working capital for storefronts across Easton, the French Quarter, Polaris and the Grandview Heights corridor.",
    services: [
      make(
  ...
  },
  {
    ...
    intro:
      "Heavy equipment, working capital and receivables financing for Central Louisiana manufacturers, Honda-corridor suppliers and Westside legacy producers.",
    services: [
      make(
  ...
  },
  {
    ...
    intro:
      "Tailored financing for New Orleans law firms, accounting practices, consulting groups and other partner-led firms — Downtown, Bexley, Dublin and Worthington.",
    services: [
      make(
        "unsecured-business-loans",
      ...
      make(
        ...
        "Local Loan Advisors",
        Calculator,
        "New Orleans-based loan brokering",
  ...
  },
  {
    ...
    intro:
      "Equipment, working capital and AR factoring for Central Louisiana industrial operators, specialty manufacturers and Gulf South supply-chain businesses.",
    services: [
      make(
        ...
        "Equipment, working capital and AR factoring for manufacturers and industrial service operators in the New Orleans metro.",
